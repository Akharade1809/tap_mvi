...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BaseState);
}
...
/// @nodoc
class $BaseStateCopyWith<$Res>  {
$BaseStateCopyWith(BaseState _, $Res Function(BaseState) __);
}
...
class _Initial implements BaseState {
  const _Initial();
...
class _Loading implements BaseState {
  const _Loading();
...
class _Success implements BaseState {
  const _Success();
...
class _Error implements BaseState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $BaseStateCopyWith<$Res> {
